	...
	<div class="row justify-content-md-center">
		<div class="col col-lg-12"></div>
                ...
                <form action="" method="post" >
                    Song Title: <input type="text" name="songtitle" placeholder="Song Title" required/>
                    Artist: <input type="text" name="artist" placeholder="Artist" />
                    Genre: <input type="text" name="genre" placeholder="Genre" required/>
                <input type="submit" class="btn btn-default btn-lg" href='#'value="Add Song"/>
                </form>
                </div>
	</div>
</div>
